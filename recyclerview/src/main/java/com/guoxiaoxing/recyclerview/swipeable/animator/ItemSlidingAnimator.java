...
package com.guoxiaoxing.recyclerview.swipeable.animator;
...
import com.guoxiaoxing.recyclerview.swipeable.SwipeableItemWrapperAdapter;
    ...
    private static class SlidingAnimatorListenerObject
        ...
        public void onAnimationEnd(View view) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                SwipeableHelper.clearViewPropertyAnimatorUpdateListener(view);
            } else {
